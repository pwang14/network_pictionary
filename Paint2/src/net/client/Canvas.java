...
public class Canvas extends JComponent {
	...
	//drawing variables
	//tempLine stores latest stroke, totalLines stores all strokes
	...
	//draw lines with corresponding colors and brush widths
	...
	//clear tempLine for a new line
	//store color and brush width as first properties
	...
	//add straight line to tempLine, adding to the stroke
	...
	//clear totalLines, removing all strokes on canvas
	public void clearTotal() {
		totalLines.clear();
		repaint();
	}
	
	//remove last stroke in totalLines
	public void remove() {
		if (totalLines.size()>0) {
